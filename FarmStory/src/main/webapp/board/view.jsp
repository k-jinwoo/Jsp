	...
	jQuery(function(){
		...
		$('.btnCommentModify').click(function(e){
			...
			if(mode == '수정'){
				...
				$.ajax({
					url: '/FarmStory/board/proc/commentUpdate.jsp',
					type: 'post',
					data: jsonData,
					dataType: 'json',
        ...
        <section id="board" class="view">
            ...
            <table>
                ...
                <tr>
                    <td>첨부파일</td>
                    <td>
                        <a href="/FarmStory/board/proc/download.jsp?seq=<%= article.getFb().getSeq() %>"><%= article.getFb().getOriName() %></a>
            ...
            <div>
	        	...
	        	<a href="/FarmStory/board/proc/delete.jsp?seq=<%= article.getSeq() %>" class="btnDelete">삭제</a>
	        	<a href="/FarmStory/board/modify.jsp?group=<%= group %>&cate=<%= cate %>&seq=<%= article.getSeq() %>" class="btnModify">수정</a>
     			<% } %>
                <a href="/FarmStory/board/list.jsp?group=<%= group %>&cate=<%= cate %>" class="btnList">목록</a>
            </div>  
            ...
            <section class="commentList">
                ...
                <article class="comment">
                    ...
                    <div>
                        <a href="/FarmStory/board/proc/commentDelete.jsp?group=<%= group %>&cate=<%= cate %>&seq=<%= comment.getSeq() %>&parent=<%= comment.getParent() %>" class="btnCommentDel">삭제</a>
            ...
            <section class="commentForm">
                <h3>댓글쓰기</h3>
                <form action="/FarmStory/board/proc/comment.jsp" method="post">
